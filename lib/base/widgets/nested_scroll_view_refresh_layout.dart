...
class NestedScrollViewRefreshLayout extends StatefulWidget {
  /// Creates a refresh indicator.
  ///
  /// The [onRefresh], [child], and [notificationPredicate] arguments must be
  /// non-null. The default
  /// [displacement] is 40.0 logical pixels.
  const NestedScrollViewRefreshLayout({
    Key key,
    @required this.child,
...
class NestedScrollViewRefreshIndicatorState
    extends State<NestedScrollViewRefreshLayout>
    with TickerProviderStateMixin<NestedScrollViewRefreshLayout> {
